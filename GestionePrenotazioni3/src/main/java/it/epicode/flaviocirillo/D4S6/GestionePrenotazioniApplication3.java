package it.epicode.flaviocirillo.D4S6;
...
import it.epicode.flaviocirillo.D4S6.config.EdificioConfig;
import it.epicode.flaviocirillo.D4S6.config.PostazioneConfig;
import it.epicode.flaviocirillo.D4S6.config.PrenotazioneConfig;
import it.epicode.flaviocirillo.D4S6.config.RuoloConfig;
import it.epicode.flaviocirillo.D4S6.config.UtenteConfig;
import it.epicode.flaviocirillo.D4S6.dao.EdificioService;
import it.epicode.flaviocirillo.D4S6.dao.PostazioneService;
import it.epicode.flaviocirillo.D4S6.dao.PrenotazioneService;
import it.epicode.flaviocirillo.D4S6.dao.RuoloService;
...
public class GestionePrenotazioniApplication3 implements CommandLineRunner {

	public static void main(String[] args) {
		SpringApplication.run(GestionePrenotazioniApplication3.class, args);
	}
...
//		((AnnotationConfigApplicationContext) ctxPren).close();
	...
	public void popolaDB() {
		...
		Utente u1 = (Utente)ctxU.getBean("user", "fcirillo", "Flavio", "flavio@cirillo.com", "test1");
		Utente u2 = (Utente)ctxU.getBean("user", "mrossi", "Mario", "mario@rossi.com", "test2");
		
		Ruolo r1 = (Ruolo)ctxR.getBean("role", TipoRuolo.ROLE_ADMIN);
		Ruolo r2 = (Ruolo)ctxR.getBean("role", TipoRuolo.ROLE_USER);
